...
//  }
    ...
    private void PopulateItems() {
        ...
        foreach(System.Collections.Generic.KeyValuePair<string, int> entry in unequippedItems) {
            ...
            equippedInventoryContainer.Connect("MouseOver", newIcon, "HoverSlot", new Godot.Collections.Array(equippedInventoryContainer));
            slotOneContainer.Connect("MouseOver", newIcon, "HoverSlot", new Godot.Collections.Array(slotOneContainer));
            slotTwoContainer.Connect("MouseOver", newIcon, "HoverSlot", new Godot.Collections.Array(slotTwoContainer));
        }
